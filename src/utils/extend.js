...
!(function() {
	...
	function mixinBefore(obj, name, extend) {
		if (obj[name]) {
			...
			obj[name] = function(options) {
				extend.call(this, options, name), selectObj.call(this, options);
			};
		} else {
			obj[name] = function(options) {
	...
	function mixinAfter(obj, name, extend) {
		if (obj[name]) {
			var selectObj = obj[name];
			obj[name] = function(options) {
				selectObj.call(this, options), extend.call(this, options, name);
			};
		} else {
			obj[name] = function(options) {
				extend.call(this, options, name);
	...
	Page = function(params) {
		"undefined" != typeof params.onShareAppMessage &&
	...
	Component = function(params) {
		mixinBefore(params, "attached", ComponentAttached), ComponentBackup(params);
	};
})();
